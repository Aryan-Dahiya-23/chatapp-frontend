...
const Login = () => {
    ...
    return (
        ...
        <div className="flex justify-center items-center h-[100dvh] w-full bg-gray-300">
            ...
            <div className="flex flex-col space-y-3 items-center h-full w-full pt-[40%] md:pt-[10%] lg:pt-5 rounded-xl md:h-3/5 md:w-3/5 lg:w-1/4 bg-white">

                <div className="h-40 w-40 lg:h-1/5 lg:w-1/5">
